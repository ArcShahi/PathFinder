...
void Menu::HandleInput() {
  ...
  if (IsKeyPressed(KEY_ENTER)) {
    switch (m_Selected) {
    case 0:
      RequestChange(StateID::AStar);
      break;
    case 1:
      RequestChange(StateID::Dijkstra);
      break;
    case 2:
      RequestChange(StateID::Versus);
      break;
    }
  }
}
...
void Menu::Draw() {
  ...
  DrawCenteredText("UP/DOWN to select, ENTER to confirm", height * alignY, 18,
                   GRAY);
}
